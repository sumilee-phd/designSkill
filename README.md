...
- ✅ **14개 스킬** — Google Stitch 공식 · Taste-Skill · Supanova 한국어 · Figma · Vercel 배포까지
...
│                    ↓                                        │
│ [4] stitch-multipage 로 다중 화면 완성                      │
│                    ↓                                        │
│ [5] react-convert 로 React 코드화 (선택)                    │
│                    ↓                                        │
│ [6] GitHub push → vercel-deploy 로 실제 배포                │
│                    ↓                                        │
│ [7] remotion-video 로 홍보 영상 생성                        │
└─────────────────────────────────────────────────────────────┘
```
