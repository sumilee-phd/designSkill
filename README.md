...
- ✅ **17개 프리셋 DESIGN.md** — Toss · Kakao · Notion · Linear · 교실용 파스텔 · 🍱 급식 Bistro 등 즉시 사용
- ✅ **11개 교사 시나리오 예제** — 학급 홍보 페이지 · 급식앱 · 학부모 안내 앱 등
...
**🏫 교육용 오리지널** — [`classroom-pastel`](./presets/education/classroom-pastel.md) · [`lesson-clean`](./presets/education/lesson-clean.md) · [`quiz-playful`](./presets/education/quiz-playful.md) · [`parent-formal`](./presets/education/parent-formal.md) · [`student-vibrant`](./presets/education/student-vibrant.md) · [`meal-bistro`](./presets/education/meal-bistro.md) 🍱
